...
export default function App() {
  ...
  if (user === undefined) return <div style={styles.loading}>Loading App 2...</div>;

  return (
    <div style={{ ...styles.page, ...styles.bg2 }}>
      <TopNav user={user} onLogout={logout} />
      <h1 style={styles.h1}>You are in App 2 ✅</h1>
      <p style={styles.p}>User can come here first, and SSO handles login redirect.</p>
    </div>
  );
}
...
const styles = {
  ...
  bg2: { background: "linear-gradient(140deg,#059669,#0f172a)" },
